function PlotROC(channel)
    close all;
    
    dataPath = fullfile("Data/ROC", channel);
    ...
    [~, lf] = legendflex(lineHandles, cellstr(lineText), "anchor", {'se', 'se'}, "buffer", [-7, 7]);
    set(lf, 'Color', 'black');
end
